...
function render() {
  ...
  const specialized = {'home':homePage,'dashboard':dashboardPage,'company-details':companyDetailsPage,'risk-vectors':riskVectorsPage,'ratings-tree':ratingsTreePage,'company-list':companyListPage,'subsidiaries':subsidiariesPage,'assessments':assessmentsPage,'breach':breachPage,'badge':badgePage,'findings-table':findingsTablePage,'issue-tracking':issueTrackingPage,'vulnerability':vulnerabilityPage};
